...
class Options:
    ...
    def _initial(self):
        ...
        self.parser.add_argument('--train_data', type=str, default='data/h36m20_train.npy')
        self.parser.add_argument('--test_root', type=str, default='data/test20_LTD')
        ...
        # self.parser.add_argument('--num_stage', type=int, default=0, help='# layers in linear model')
        self.parser.add_argument('--DS_stage', type=int, default=9, help='# layers in linear model')
        self.parser.add_argument('--node_n', type=int, default=66, help='nodes')
        ...
        self.parser.add_argument('--test_interval', type=int, default=1000)
        self.parser.add_argument('--save_interval', type=int, default=2)
        self.parser.add_argument('--loss_interval', type=int, default=100)
